...
class nginx (
  ...
  create_resources('::nginx::upstream', $nginx_upstreams)
  create_resources('::nginx::vhost', $nginx_vhosts, $nginx_vhosts_defaults)
  create_resources('::nginx::location', $nginx_locations)
  create_resources('::nginx::mailhost', $nginx_mailhosts)
  create_resources('::nginx::map', $string_mappings)
  create_resources('::nginx::geo', $geo_mappings)
