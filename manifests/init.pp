...
class nginx (
  ...
  ### START Nginx Configuration ###
  Optional[Nginx::Toggle] $absolute_redirect                 = undef,
  ...
  Nginx::Toggle $server_tokens                               = 'on',
  Boolean $spdy                                              = false,
  Boolean $http2                                             = false,
  Nginx::Toggle $ssl_stapling                                = 'off',
  Nginx::Toggle $ssl_stapling_verify                         = 'off',
