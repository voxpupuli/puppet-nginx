...
define nginx::resource::location (
  ...
  Nginx::Time $proxy_read_timeout                                  = $nginx::proxy_read_timeout,
  Nginx::Time $proxy_connect_timeout                               = $nginx::proxy_connect_timeout,
  Nginx::Time $proxy_send_timeout                                  = $nginx::proxy_send_timeout,
